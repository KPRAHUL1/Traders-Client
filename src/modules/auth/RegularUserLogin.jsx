...
export default function RegularUserLogin() {
  const { login } = useAuth()
      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Sign in with your mobile number to access our integrated marketplace
          </p>
        </div>
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-gray-500">Need a specific role?</span>
              </div>
            </div>
            ...
            <div className="mt-6">
              ...
              >
                Choose Role (Agent, Manufacturer, Contractor)
              </button>
            </div>
          </div>
        </div>
